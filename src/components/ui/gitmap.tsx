...
export function Gitmap({
  ...
  return (
    ...
    >
      {showMonths && (
        <div className="absolute top-0" style={{ left: showDays ? DAY_LABEL_WIDTH : 0 }}>
      ...
      {showDays && (
        <div className="absolute left-0.5" style={{ top: showMonths ? MONTH_LABEL_HEIGHT : 0, width: DAY_LABEL_WIDTH }}>
